...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32719',
            //extent: [-7983220.712400, -4067898.921000, 352958.125434, 6299127.185008],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([162014.969583, 6180657.087883, 520523.834192, 6397329.363254], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Actividades VcM 2024 Región Metropolitana</h2>';
        return titleElement;
    })(),
